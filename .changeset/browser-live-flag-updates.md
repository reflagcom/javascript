...
Add `enableLiveFlagUpdates` support. When enabled, the browser SDK subscribes to live flag changes from the Reflag servers. The browser SDK keeps live flag updates disabled by default.
