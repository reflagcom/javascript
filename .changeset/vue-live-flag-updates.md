...
Live flag updates are now enabled by default. The Vue SDK subscribes to Reflag SSE through the browser SDK and refreshes flags automatically when they change.
