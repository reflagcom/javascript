...
| `flagsPushUrl`          | string                                | Push endpoint used when `flagsSyncMode: "push"`. The SDK opens it as an authenticated streaming GET. Default: `https://pubsub.reflag.com/sse/server`.                                                                                               | -                                           |
